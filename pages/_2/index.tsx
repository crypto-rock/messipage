import styles from "../../styles/page/page2.module.css";
import Image from "next/image";
import mark from "../../asset/fcb.png";
import MessiFace from "../../asset/MessiFace.png";
  ...
  return (
    <div className={styles.body}>
      <div className={styles.container}>
            ...
            <div className={styles.lefttitle}>
              ...
              <div className={styles.titleSocial}>
                <div className={styles.titleTwitter}>
                  ...
                  <span>Follow Messi on Twitter</span>
                </div>

                <div className={styles.titleFacebook}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="25"
                    height="25"
                ...
                <div className={styles.titleLinkin}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="25"
                    height="25"
          ...
          <div className={styles.middle}>
            ...
            <div className={styles.playForm}>
              <div className={styles.round}>
                <div className={styles.oldMiddle}>
                  <div className={styles.oldTriangle}></div>
                </div>
              </div>
            </div>
            <div className={styles.year}>
              <div className={styles.yearPart1}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="25"
                  height="25"
        ...
        <span className={styles.piece}>Latest articles</span>
        <div className={styles.footer}>
          <div className={styles.part}>
            <p>NCCA Tournament adds: </p>
            <p>Picked for every first-round game.</p>
